...
<section class="bg-white py-20 lg:py-[60px] overflow-hidden relative z-10">
   <div class="container">
      <div class="flex flex-wrap lg:justify-between -mx-4">
         <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
            <div class="max-w-[200px] mb-12 lg:mb-0">
         ...
         <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
            <div class="bg-white relative rounded-lg p-8 sm:p-12 shadow-lg">
               <form action='https://formspree.io/f/xpznjnzl' method='POST'>
                  <div class="mb-6">
                     <input
                     name='username'
                        type="text"
